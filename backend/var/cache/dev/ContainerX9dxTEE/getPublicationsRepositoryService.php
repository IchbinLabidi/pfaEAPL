...
class getPublicationsRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PublicationsRepository.php';

        return $container->privates['App\\Repository\\PublicationsRepository'] = new \App\Repository\PublicationsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
